...
pub contract MetaPandaAirdropNFT: NonFungibleToken {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: "Meta Panda Airdrop NFT ".concat(self.id.toString()),
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        ...
                        publicCollection: Type<&MetaPandaAirdropNFT.Collection>(),
                        publicLinkedType: Type<&MetaPandaAirdropNFT.Collection{NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&MetaPandaAirdropNFT.Collection{NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
    ...
    init() {
        ...
        self.account.link<&MetaPandaAirdropNFT.Collection{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, AnchainUtils.ResolverCollection}>(
